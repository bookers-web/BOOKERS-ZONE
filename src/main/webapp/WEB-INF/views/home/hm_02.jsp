...
$(document).ready(function() {
    ...
    const stored = sessionStorage.getItem('bookMenuOpen_hm02');
    const isOpen = stored === null ? true : stored === 'Y'; // 아무 값이 없을 때는 true 
    const bookMenuOpen_hm02_stop = sessionStorage.getItem('bookMenuOpen_hm02_stop')
    ...
    if (bookMenuOpen_hm02_stop === 'Y' && hasMainCategory) { // 고정 시키는 서브밋 이면 true 열림 
    ...
    $sortSelect.on('change', function () {
        ...
        sessionStorage.setItem('bookMenuOpen_hm02_stop', 'Y');
    ...
    $('#toggleButton').on('click', function () {
        ...
        if ($menu.hasClass('open')) {
        	sessionStorage.setItem('bookMenuOpen_hm02', "Y");
        } else {
        	sessionStorage.setItem('bookMenuOpen_hm02', "N");
        }
        //console.log("sessionStorage: ", sessionStorage.getItem('bookMenuOpen_hm02'));
    });
});
...
function fn_search(uct_type, uct_code, uct_parent){
	...
	sessionStorage.setItem('bookMenuOpen_hm02_stop', 'N');
...
<div id="wrap">
	<div id="header">
		...
		<nav id="snb">
			<ul class="snb_list">
				...
				<li>
					<a href="/front/home/newBookList.do" class="nav_focus">최신 업데이트</a>
				</li>
				<li>
	...
	<div id="container">
		<div class="content">
			<form name="frm" id="frm" action="/front/home/newBookList.do" method="post">
				<input type="hidden" id="uil_code" name="uil_code" value="${ormRecommendVO.uil_code }" />
				...
				<c:forEach items="${chooseCmList }" var="list" varStatus="status">
					...
					<li class="book-item" data-ucm-code="${list.ucm_code}" data-ume-code="${list.ume_code}" data-ume-codes="">
						...
						<div class="listBtnArea">
							...
							<div class="btnWrap">
						        <button type="button" class="bt-func-library ${not empty list.ume_code ? 'is-added' : ''}">
						        <c:choose>
